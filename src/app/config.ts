export const CARBON_PROTOCOL:string = globalConfigIsSet( "CARBON_PROTOCOL" ) ? window[ "__CONFIG" ][ "CARBON_PROTOCOL" ] : (<any>process.env.CARBON).protocol;
export const CARBON_HOST:string = globalConfigIsSet( "CARBON_HOST" ) ? window[ "__CONFIG" ][ "CARBON_HOST" ] : (<any>process.env.CARBON).domain;
